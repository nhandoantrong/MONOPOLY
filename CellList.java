...
public class CellList extends ArrayList<Cell>
{
	public CellList()
	{
		...
		this.add(new ChanceCell("Community Chest",2));
		...
		this.add(new ChanceCell("Community Chest",17));
		...
		this.add(new ChanceCell("Chance",22));
